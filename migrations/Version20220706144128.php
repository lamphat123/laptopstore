 ...
 */
final class Version20220706144128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD supplier_id INT DEFAULT NULL, DROP supplier, CHANGE pro_date pro_date DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD supplier VARCHAR(255) NOT NULL, DROP supplier_id, CHANGE pro_date pro_date DATE NOT NULL');
    }
}
