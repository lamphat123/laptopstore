 ...
 */
final class Version20220703075206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD supplier_id INT DEFAULT NULL, ADD category VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP supplier_id, DROP category');
    }
}
